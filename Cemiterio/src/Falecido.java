...
public class Falecido extends Pessoa implements DadosPessoais{
    ...
    Falecido(String nome, String sobrenome, String cpf, Date dataNasc, char genero, String estadoCivil, String bairro, String rua, int numero, int quadra, String cep, int plano, Date dataEnterro, String ocupacao, String religiao) {
